...
- **Interactive Flow Studio**: Buka [`_docs/index.html`](./_docs/index.html) di browser untuk mengakses Studio Drag-and-Drop Diagram Alur & Runbook SOP interaktif.

---

## 📚 Dokumentasi & Flow Studio

Buka [`_docs/index.html`](./_docs/index.html) di browser untuk studio dokumentasi & diagram alur interaktif:
- 🎨 **Drag-and-Drop Canvas** — tambah, geser, dan susun node alur kerja secara visual
- 🔗 **Interactive Port Wiring** — hubungkan antar node dengan kurva SVG yang dapat di-drag
- 🚀 **Simulasi Eksekusi** — jalankan simulasi alur pipeline secara visual step-by-step
- 📖 **Runbook / SOP** — panduan lengkap urutan instruksi scraping Notudo Finance
- 📥 **Export / Import JSON** — simpan dan muat kembali desain alur kerja
